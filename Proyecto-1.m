...
cromosoma = sortrows(tabla,5, 'descend');
ecu_final = cromosoma(:,1);
coef_final = cromosoma(:,5);
coef_final = double(coef_final);
resultados = subs(ecu_final,x,0:0.1:1);
res_final = double(resultados);
coef_final, ecu_final
res_final
